...
```
sudo apt update -y && sudo apt-get -y install git net-tools procps --no-install-recommends && sudo git clone https://github.com/CamoCatX/Ubuntu-hardeded.git && cd Ubuntu-hardeded && sudo bash ubuntu.sh
```
